...
To run this experiment I rented a NVIDIA A5000 for around 15 hours. From the plot below you can see that using a batch size of 128 I was able to run around 28k iterations.
...
Honestly, I do not want to maintain this repo, and since there a lot of implementations of the Transformer architecture out there, I don' think you will need this repo. But, if you find it useful, give me a star :)
